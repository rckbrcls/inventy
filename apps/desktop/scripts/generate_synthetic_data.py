...
Usage:
    pip install faker
    python scripts/generate_synthetic_data.py --db-path ./data/inventy.db --seed 42
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python generate_synthetic_data.py --db-path ./data/inventy.db
    python generate_synthetic_data.py --db-path ./data/inventy.db --seed 12345
        """,
    )
    parser.add_argument(
        "--db-path",
