...
export const Route = createFileRoute("/shops/$shopId/payments/new")({
...
function NewPayment() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.transaction_id || !formData.amount || !formData.provider || !formData.method) {
    ...
    try {
      ...
      await PaymentsRepository.create(payload)
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Register a new payment for a transaction.
        </p>
      </div>
        ...
        <div className="grid gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Basic payment details including transaction and amount.
              </CardDescription>
            </CardHeader>
