...
import { ProductsRepository, UpdateProductDTO } from "@/lib/db/repositories/products-repository"
...
export const Route = createFileRoute("/shops/$shopId/products/$productId/edit")({
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleChange("brand_id", value === "none" ? "" : value)
                    }
                  >
                    <SelectTrigger>
